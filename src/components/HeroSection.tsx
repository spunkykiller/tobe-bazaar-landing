      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-10 sm:space-y-12">
          ...
          <div className="space-y-6 fade-in-up">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-poppins font-bold gradient-text-animated leading-tight tracking-tight">
          ...
          <div className="max-w-2xl mx-auto fade-in-up" style={{ animationDelay: '0.2s', opacity: 0 }}>
            ...
            {error && (
              <div className="mt-4 p-4 rounded-xl bg-destructive/10 border border-destructive/30 animate-in fade-in slide-in-from-top-2">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center fade-in-up" style={{ animationDelay: '0.4s', opacity: 0 }}>
            <Button 
              size="lg" 
              variant="hero"
